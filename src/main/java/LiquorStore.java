...
public class LiquorStore
{
    ...
    public LiquorStore(String name, String streetAddress, String phone)
    {
        this.name = name;
    ...
    public LiquorStore(String name, String streetAddress, String city, String state, String zipCode, String phone, String linkFoundOn) {
        this.setName(name);
